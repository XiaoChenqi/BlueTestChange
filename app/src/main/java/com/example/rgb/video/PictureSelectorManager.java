...
import com.example.utils.FMFileUtils;
import com.luck.picture.lib.PictureSelector;
import com.luck.picture.lib.config.PictureMimeType;
...
//    }
//
    public static void camera(Activity activity, int requestCode, String waterMark) {
        camera(activity, requestCode, waterMark, false);
    }
...
//    }
//拍照
    public static void camera(Activity activity, int requestCode, String waterMark, boolean enableCrop) {
...
//                .forResult(requestCode);
    ...
    public static void cameraVideo(Activity activity, int requestCode) {
//        PictureSelector.create(fragment)
//                .openCamera(PictureMimeType.ofVideo())
//                .videoQuality(0)
//                .setOutputCameraPath(FMFileUtils.getVideoPath())
...
//                .forResult(requestCode);
        ...
        Intent intent = new Intent(activity, Camera2RecordActivity.class);
